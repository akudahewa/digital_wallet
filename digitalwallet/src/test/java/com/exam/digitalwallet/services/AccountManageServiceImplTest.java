...
//	@Test
//	void testAddBalance() {
//		Account account= new Account("4", "wallert-3", 0, true);
//		Account account2= new Account("4", "wallert-3", 86, true);
//		when(accountRepository.findById("1")).thenReturn(Optional.of(account));
//		when(PromotionContext.executePromotion("WELCOME",Optional.of(account),50))
//		.thenReturn(20);
...
//		Account acc = accountManageService.addBalance("3", recharge);
